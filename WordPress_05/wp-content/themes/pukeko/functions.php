...
if ( ! function_exists( 'pukeko_setup' ) ) :
	...
	function pukeko_setup() {
		 ...
		 * If you're building a theme based on Pukeko, use a find and replace
		 * to change 'pukeko' to the name of your theme in all the template files.
		 */
		...
		add_theme_support( 'post-thumbnails' );
			...
			add_image_size( 'pukeko-fi-classic', 2010, 1340, true ); // Image Ratio 3:2 (classic film).
			add_image_size( 'pukeko-fi-hd', 2000, 1125, true ); // Image Ratio 16:9 (Video HD).

		// Set the default content width.
		$GLOBALS['content_width'] = 784;
...
function pukeko_content_width() {
	...
	// Check if its a fullwidth page template.
	...
	/**
	 * Filter Pukeko content width of the theme.
	 *
	 * @since Pukeko 1.0
	 *
	 * @param int $content_width Content width in pixels.
	 */
	$GLOBALS['content_width'] = apply_filters( 'pukeko_content_width', $content_width );
}
add_action( 'template_redirect', 'pukeko_content_width', 0 );
