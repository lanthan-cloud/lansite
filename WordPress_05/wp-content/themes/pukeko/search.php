...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title f1"><?php printf( esc_html__( 'Search Results for: %s', 'pukeko' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
			</header><!-- .page-header -->
	...
	<?php if ( have_posts() && 'blog-only' == get_theme_mod( 'pukeko_blogsidebar') || have_posts() && 'blog-post' == get_theme_mod( 'pukeko_blogsidebar') ) : ?>
	<?php get_sidebar(); ?>
	<?php endif; ?>
