...
function pukeko_posted_on() {
	...
	if ( is_single () || is_sticky () ) {
		...
		echo '<span class="author-meta-info"><span class="byline"> ' . $byline . '</span><span class="posted-on">' . esc_html__( 'on', 'pukeko' ) . $posted_on . '</span>';
